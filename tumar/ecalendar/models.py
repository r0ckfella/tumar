...
class Event(models.Model):
    ...
    scheduled_date = models.DateField(default=datetime.date.today, verbose_name=_('Scheduled date of the event'))
    completion_date = models.DateField(null=True, verbose_name=_('Date of the event completion'))
    type = models.CharField(max_length=2, choices=TYPE_CHOICES,
                            default=OTHER, verbose_name=_('Type of the event'))
...
class BreedingStockEvent(Event):
    animal = models.ForeignKey(BreedingStock, on_delete=models.CASCADE,
                               related_name="events", verbose_name=_('Cow Animal of the event'))
...
class CalfEvent(Event):
    animal = models.ForeignKey(Calf, on_delete=models.CASCADE,
                               related_name="events", verbose_name=_('Calf Animal of the event'))
