...
class FarmFactory(factory.django.DjangoModelFactory):
    ...
    # cadastres = factory.List(
    #     [
    #         factory.Faker("numerify", text="#############")
    ...
    #         temp_polygon = [
    #             (
    #                 float(faker.coordinate(center=center_lon, radius=0.004)),
    #                 float(faker.coordinate(center=center_lat, radius=0.002)),
    #             )
...
class AnimalFactory(factory.django.DjangoModelFactory):
    ...
    class Params:
        parents = factory.Trait(farm=factory.SubFactory(FarmFactory),)
...
class GeolocationFactory(factory.django.DjangoModelFactory):
    ...
    def time(self):
        time = faker.date_time_between(
            tzinfo=timezone("Asia/Almaty"),
            end_date="now",
            start_date=datetime.datetime(2019, 12, 1, tzinfo=timezone("Asia/Almaty")),
        )
    ...
    class Params:
        parents = factory.Trait(animal=factory.SubFactory(AnimalFactory),)
...
class EventFactory(factory.django.DjangoModelFactory):
    ...
    time = factory.Faker(
        ...
        start_date=datetime.datetime(2016, 1, 1, tzinfo=timezone("Asia/Almaty")),
    )
